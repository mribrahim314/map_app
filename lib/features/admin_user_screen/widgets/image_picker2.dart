...
class ImagePickerWidget2 extends StatefulWidget {
  ...
  @override
  State<ImagePickerWidget2> createState() => _ImagePickerWidgetState2();
}

class _ImagePickerWidgetState2 extends State<ImagePickerWidget2> {
  @override
                  ...
                  builder: (BuildContext context) {
                    return Dialog(
                      ...
                      child: GestureDetector(
                        ...
                        child: Hero(
                          tag: widget
                              .imageURL!, // Optional: for smooth transition if you use Hero elsewhere
                          child: Material(
